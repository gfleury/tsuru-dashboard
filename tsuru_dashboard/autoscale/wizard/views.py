...
from tsuru_dashboard.autoscale.wizard import forms
from tsuru_dashboard.autoscale.wizard import client
from tsuru_dashboard.autoscale.datasource import client as dclient
...
def new(request, instance=None):
    ...
    if scale_up_form.is_valid() and scale_down_form.is_valid() and config_form.is_valid():
        ...
        url = "{}".format(reverse("autoscale-app-info", args=[instance]))
        return redirect(url)
    ...
    return render(request, "autoscale/wizard/index.html", context)
